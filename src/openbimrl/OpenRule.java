...
import de.rub.bi.inf.openbimrl.ModelCheckType;
import de.rub.bi.inf.openbimrl.ModelSubCheckType;
import de.rub.bi.inf.openbimrl.ModelSubChecksType;
import de.rub.bi.inf.openbimrl.NodeType;
import de.rub.bi.inf.openbimrl.PrecalculationsType;
import de.rub.bi.inf.openbimrl.ResultSetType;
import de.rub.bi.inf.openbimrl.RuleIdentifierType;
...
public class OpenRule extends RuleSet {
	 ...
	 * @param ifcModel
	 */
	private void handlePrecalculations(ApplicationModelNode ifcModel) {
	 ...
	 * @param ifcModel
	 */
	private void handleRuleChecks(ApplicationModelNode ifcModel) {
