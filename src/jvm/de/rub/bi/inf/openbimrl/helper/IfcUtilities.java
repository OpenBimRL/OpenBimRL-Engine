...
public class IfcUtilities {
  ...
  /*  public static class Ifc2x3 {
        ...
        public static Collection<IfcObject.Ifc2x3> getObjectsByProperty(IIFCModel modelNode,
    ...
    public static class Ifc4 {
        ...
        public static Collection<IfcObject.Ifc4> getObjectsByProperty(IIFCModel modelNode,
