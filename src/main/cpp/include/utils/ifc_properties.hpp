...
extern "C"
{
    ...
    bool getPropertySetName(std::size_t, JNA::String);
    bool getPropertyName(std::size_t, std::size_t, JNA::String);
    bool getPropertyValue(std::size_t, std::size_t, JNA::String);
}
#endif